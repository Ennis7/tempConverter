    ...
    class temps
    {
        ...
        private static void convertTemp(char type, int numToConvert)
        {
            ...
            if (type == 'F')
            {
                ...
                Console.WriteLine($"{numToConvert} degrees celsius converted to fehrenheit is {convertedValue}");
            }
            else convertedValue = (numToConvert - 32) * 5 / 9;
            Console.WriteLine($"{numToConvert} degrees fehrenheit converted to celsius is {convertedValue}");
        }
